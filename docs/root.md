...
- [Control API](features/control-api/feature.md) — HTTP endpoints, request/response
  contracts, the per-torrent snapshot, and the SSE event stream.
- [Torrent engine](features/torrent-engine/feature.md) — the MonoTorrent `ClientEngine`
  wrapper: settings, lifecycle, state→event mapping, and snapshot derivation.
- [VPN isolation and killswitch](features/vpn-isolation/feature.md) — OpenVPN bring-up, the
  iptables killswitch, DNS routing, the status monitor, and the download gate.
- [VPN profiles](features/vpn-profiles/feature.md) — the operator's folder of OpenVPN
  profiles, the active-profile rule, and runtime switching through the API.
...
- [Hosty runtime app](features/hosty-runtime-app/feature.md) — the manifest, runtime
  profile, capabilities/devices, settings, app data, and telemetry.
- [Consumer integration](features/consumer-integration/feature.md) — how a consumer declares
  the dependency, discovers the engine, and tolerates its absence.
- [Configuration](features/configuration/feature.md) — the full environment-variable
  reference.
- [Build and deployment](features/build-and-deployment/feature.md) — the Native AOT
...
- **build-and-deployment** — [feature](features/build-and-deployment/feature.md)
- **configuration** — [feature](features/configuration/feature.md)
- **consumer-integration** — [feature](features/consumer-integration/feature.md)
- **control-api** — [feature](features/control-api/feature.md)
- **dht** — [feature](features/dht/feature.md)
- **docker-development** — [feature](features/docker-development/feature.md) · [plan](features/docker-development/plan.md): In Progress, updated 2026-09-17
- **hosty-runtime-app** — [feature](features/hosty-runtime-app/feature.md)
- **torrent-engine** — [feature](features/torrent-engine/feature.md)
- **vpn-isolation** — [feature](features/vpn-isolation/feature.md) · [plan](features/vpn-isolation/plan.md): In Progress, updated 2026-09-17
- **vpn-profiles** — [feature](features/vpn-profiles/feature.md)
